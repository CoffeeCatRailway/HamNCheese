 ...
 * Created: 27/07/2022
 */
public class PopcornMachineTrigger extends SimpleCriterionTrigger<PopcornMachineTrigger.TriggerInstance>
{
    static final ResourceLocation ID = HamNCheese.getLocation("popcorn_machine_use");
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance
    {
        ...
        public static TriggerInstance usePopcornMachine()
        {
