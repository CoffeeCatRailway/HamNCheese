 ...
 * Created: 27/07/2022
 */
public class CheeseTrigger extends SimpleCriterionTrigger<CheeseTrigger.TriggerInstance>
{
    static final ResourceLocation ID = HamNCheese.getLocation("cheese");
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance
    {
        ...
        public static TriggerInstance trigger(Type type)
        {
    ...
    public enum Type
    {
        ...
        static CheeseTrigger.Type getById(String id)
        {
            if (id.toLowerCase(Locale.ROOT).equals("swiss"))
                return SWISS;
            return BLUE;
        }
    }
