 ...
 * Created: 27/07/2022
 */
public class BlueCheeseTrigger extends SimpleCriterionTrigger<BlueCheeseTrigger.TriggerInstance>
{
    static final ResourceLocation ID = HamNCheese.getLocation("blue_cheese");
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance
    {
        ...
        public static TriggerInstance waitForBlueCheese()
        {
