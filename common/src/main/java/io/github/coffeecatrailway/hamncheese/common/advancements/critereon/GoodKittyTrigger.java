 ...
 * Created: 27/07/2022
 */
public class GoodKittyTrigger extends SimpleCriterionTrigger<GoodKittyTrigger.TriggerInstance>
{
    static final ResourceLocation ID = HamNCheese.getLocation("good_kitty");
    ...
    public static class TriggerInstance extends AbstractCriterionTriggerInstance
    {
        ...
        public static TriggerInstance killMouse()
        {
