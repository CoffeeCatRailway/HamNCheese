...
public class HNCFeatures
{
    ...
    public static class Configured
    {
        ...
        private static final Supplier<ConfiguredFeature<TallCropFeatureConfiguration, ?>> WILD_PINEAPPLE = CONFIGURED_FEATURES.register("wild_pineapple",
                () -> new ConfiguredFeature<>(TALL_CROP.get(), new TallCropFeatureConfiguration(HamNCheese.CONFIG_SERVER.wildPineapplesProbability.get().floatValue(), HamNCheese.CONFIG_SERVER.wildPineapplesSpread.get(),
        ...
        public static final Supplier<PlacedFeature> WILD_PINEAPPLE_PLACEMENT = PLACEMENTS.register("wild_pineapple", () -> new PlacedFeature(Holder.direct(WILD_PINEAPPLE.get()), List.of(RarityFilter.onAverageOnceEvery(HamNCheese.CONFIG_SERVER.wildPineapplesChance.get()), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
        ...
        private static final Supplier<ConfiguredFeature<TallCropFeatureConfiguration, ?>> WILD_TOMATO = CONFIGURED_FEATURES.register("wild_tomato",
                () -> new ConfiguredFeature<>(TALL_CROP.get(), new TallCropFeatureConfiguration(HamNCheese.CONFIG_SERVER.wildTomatoesProbability.get().floatValue(), HamNCheese.CONFIG_SERVER.wildTomatoesSpread.get(),
        ...
        public static final Supplier<PlacedFeature> WILD_TOMATO_PLACEMENT = PLACEMENTS.register("wild_tomato", () -> new PlacedFeature(Holder.direct(WILD_TOMATO.get()), List.of(RarityFilter.onAverageOnceEvery(HamNCheese.CONFIG_SERVER.wildTomatoesChance.get()), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
        ...
        private static final Supplier<ConfiguredFeature<TallCropFeatureConfiguration, ?>> WILD_CORN = CONFIGURED_FEATURES.register("wild_corn",
                () -> new ConfiguredFeature<>(TALL_CROP.get(), new TallCropFeatureConfiguration(HamNCheese.CONFIG_SERVER.wildCornProbability.get().floatValue(), HamNCheese.CONFIG_SERVER.wildCornSpread.get(),
        ...
        public static final Supplier<PlacedFeature> WILD_CORN_PLACEMENT = PLACEMENTS.register("wild_corn", () -> new PlacedFeature(Holder.direct(WILD_CORN.get()), List.of(RarityFilter.onAverageOnceEvery(HamNCheese.CONFIG_SERVER.wildCornChance.get()), InSquarePlacement.spread(), PlacementUtils.HEIGHTMAP_WORLD_SURFACE)));
        ...
        public static final Supplier<ConfiguredFeature<TreeConfiguration, ?>> MAPLE_TREE = CONFIGURED_FEATURES.register("maple_tree", () -> new ConfiguredFeature<>(Feature.TREE, new TreeConfiguration.TreeConfigurationBuilder(
        ...
        public static final Supplier<PlacedFeature> MAPLE_TREE_PLACEMENT = PLACEMENTS.register("maple_tree", () -> new PlacedFeature(Holder.direct(MAPLE_TREE.get()), VegetationPlacements.treePlacement(PlacementUtils.countExtra(0, HamNCheese.CONFIG_SERVER.mapleTreeWeight.get().floatValue(), 1), HNCBlocks.MAPLE_SAPLING.get())));
